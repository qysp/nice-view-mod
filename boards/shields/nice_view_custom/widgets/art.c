...
#ifndef LV_ATTRIBUTE_IMG_SHOPWARE_LOGO
#define LV_ATTRIBUTE_IMG_SHOPWARE_LOGO
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_SHOPWARE_LOGO uint8_t shopware_logo_map[] = {
#if CONFIG_NICE_VIEW_WIDGET_INVERTED
...
const lv_img_dsc_t shopware_logo = {
  .header.cf = LV_IMG_CF_INDEXED_1BIT,
  .header.always_zero = 0,
  .header.reserved = 0,
  .header.w = 140,
